...
public class Snake {
    ...
    public void move() {
        ...
        for (int d = length - 1; d > 0; d--) {
            if ((snakeX[0] == snakeX[d]) & (snakeY[0] == snakeY[d])) length = 0; //tiene que ser snakeY y con length 0 nos aseguramos que salga del bucle
        }

        if (snakeX[0] >= main.WIDTH) snakeX[0] = 0; // se añade el igual para que no exista la "pared invisible"
